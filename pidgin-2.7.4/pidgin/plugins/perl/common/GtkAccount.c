...
XS(boot_Pidgin__Account)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Pidgin::Account::get_handle", XS_Pidgin__Account_get_handle, file, "");
        newXSproto("Pidgin::Account::Dialog::show", XS_Pidgin__Account__Dialog_show, file, "$$");
        newXSproto("Pidgin::Account::Window::show", XS_Pidgin__Account__Window_show, file, "");
        newXSproto("Pidgin::Account::Window::hide", XS_Pidgin__Account__Window_hide, file, "");
    if (PL_unitcheckav)
